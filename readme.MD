...
From 5.0.0 version is not backward compatible!
...
```
<h4>6) CharacterJsonTypeResolver </h4>
...
```
<h4>7) BooleanJsonTypeResolver </h4>
...
```
<h4>8) StringJsonTypeResolver </h4>
