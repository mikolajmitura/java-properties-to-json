...
<h3>Resolvers for first conversion phase (from raw text to some concrete java object) order is important</h3>
...
<h3>Converters for second conversion phase (from object to concrete json object, field) </h3>
