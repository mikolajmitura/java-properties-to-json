...
```java
    String json = new PropertiesToJsonConverter(
            ...
            new StringJsonTypeResolver() // always added as last from default
...
<h4>3) NumberJsonTypeResolver </h4>
...
```
<h4>4) BooleanJsonTypeResolver </h4>
...
```
<h4>5) StringJsonTypeResolver </h4>
